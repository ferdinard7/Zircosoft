      ...
      <div className="login-wrapper">
        <div className="login">
          ...
          <form className="login-form" onClick={handleLogin}>
            ...
            <p>
              {" "}
              <input type="checkbox" /> i agree to Zircosoft terms and conditions
            </p>
        ...
        <div className="empty">
          <div className="first-empty">{/* first */}</div>
          <div className="second-empty">{/* second */}</div>
          <div className="third-empty">{/* third */}</div>
        </div>
      </div>
    </div>
  );
